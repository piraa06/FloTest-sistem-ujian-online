...
<div class="topbar"><div><h1>Ubah Soal</h1><p>Perbarui soal yang sudah ada.</p></div></div>
<section class="panel">
...
<div class="form-actions"><button class="btn-success" type="submit">Simpan Perubahan</button><a class="btn btn-secondary" href="index.php">Batal</a></div>
</form>
</section>
